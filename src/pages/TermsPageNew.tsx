      ...
      <main className="flex-grow py-12">
        <div className="container max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4 text-gray-900">Termos de Uso</h1>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            <div className="max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">4. Cadastro e Conta do Usuário</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">5. Uso Aceitável</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">Você concorda em não usar nossos serviços para:</p>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">6. Planos e Pagamentos</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">7. Política de Cancelamento</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">8. Propriedade Intelectual</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">9. Limitação de Responsabilidade</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">10. Disponibilidade dos Serviços</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">11. Modificações dos Termos</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">12. Lei Aplicável</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">13. Contato</h2>
                <p className="mb-4 text-gray-700 leading-relaxed">
